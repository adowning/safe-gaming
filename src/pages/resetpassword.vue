...
const updatePassword = (password, password2) => {
  const token = router.currentRoute.value.params.access_token
  if (password == password2)
    userStore.updatePassword(token, email)
}
onMounted(() => {
  userStore.resetpassword('ashdowning@gmail.com')
    ...
    <div class="container px-6 py-12 h-full">
      <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
        <div class="md:w-8/12 lg:w-6/12 mb-12 md:mb-0">
          <img
            src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.svg" class="w-full"
            alt="Phone image"
          >
        </div>
        <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
          <form>
            ...
            <div class="mb-6">
              <input
                v-model="password2" type="password"
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                placeholder="Password"
              >
            </div>
            ...
            <button
              ...
              data-mdb-ripple="true" data-mdb-ripple-color="light" @click="updatePassword(password, password2)"
            >
              Sign in
            </button>
