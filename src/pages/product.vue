<template>
        ...
        <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-9">
          <div class="rounded-md shadow-md">
            <router-link to="/contact"
              class="w-full flex items-center justify-center px-8 py-3 border-transparent text-base font-medium rounded-lg text-white bg-voxo-red md:py-3 md:text-lg hover:bg-voxo-red-dark">
              Get started
            </router-link>
          </div>
        </div>
    ...
    <div class="relative pt-16 pb-0 lg:pb-32 overflow-hidden">
      <div id="call-center" class="relative">
        <div class="max-w-xl lg:max-w-7xl lg:px-8 mx-auto px-4 sm:px-6">
          <img src="/assets/images/icons/icon-call-center.svg" alt="Call Center" />
        </div>
        <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24 py-4">
          <div class="px-4 max-w-xl mx-auto sm:px-6 lg:max-w-none lg:mx-0 lg:px-0">
            <div>
              ...
              <p class="py-8">
                Meet the ultimate Call Center where it’s all about the analytics. Get real-time data to make key
                business
          ...
          <div class="mt-12 sm:mt-16 lg:mt-0">
            <div class="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
              <img
                class="bg-voxo-gray-light p-4 w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
                src="/assets/images/omnia-preview-light.svg" alt="OMNIA preview" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
          <div class="px-4 max-w-xl mx-auto sm:px-6 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
            <div>
              <div class="lg:mx-auto lg:max-w-7xl lg:pr-8">
                <img src="/assets/images/icons/icon-mobility.svg" alt="Call Center" />
              </div>
              <div class="mt-6">
                <h1 class="text-3xl font-bold text-voxo-gray-header tracking-tight md:text-5xl">
                  Mobility
                ...
                <p class="mt-4">
                  Designed with the end-user in mind, VOXO’s mobile app gives every user the on-the-go functionality
                  that’s
                  needed in today’s business environment. Make and receive calls from your desk extension, text, and
                  even
                  listen to voicemail all from the phone in your pocket.
                </p>
                <p class="mt-4">
                  VOXO’s integration with your phone’s native dialer will help you easily see whether a call is for
                  business
          ...
          <div class="mt-12 sm:mt-16 lg:mt-0 lg:col-start-1">
            <div class="pr-0 lg:pr-6 lg:px-0 lg:relative lg:h-full">
              <img class="w-3/4 mx-auto lg:absolute lg:right-0 lg:w-auto lg:max-w-none"
                src="/assets/images/mobility-image.svg" alt="VOXO Mobility" />
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="pbx-features" class="relative bg-opacity-0 pb-10 lg:pb-24">
    <div class="max-w-xl lg:max-w-7xl lg:px-8 mx-auto px-4 sm:px-6">
      <img class="mx-auto" src="/assets/images/icons/icon-pbx.svg" alt="PBX Features" />
      ...
      <p class="max-w-4xl mx-auto text-center">
        Not all VoIP Providers are alike. We have built our PBX from the ground up, and are constantly innovating to
        reshape
        the telecom industry. With our fully featured communications platform you’ll be able to manage your
        organization’s call
        flow and communicating will be easy, reliable, and save you a ton of money. Built in redundancy, simple billing,
        and
        our top-tier support will allow you to breathe easy knowing that your company can effectively and easily
        communicate
    ...
    <div class="max-w-7xl lg:px-8 mx-auto px-4 sm:px-6">
      <div class="w-full flex flex-wrap justify-center gap-5 mt-10">
        <div v-for="feature in pbxFeatures" :key="feature.name"
  ...
  <div id="desktop-app" class="relative mt-10">
    <div class="lg:mx-auto lg:max-w-7xl lg:px-8 flex lg:space-x-8 sm:justify-between items-center flex-wrap">
      <div class="px-4 max-w-xl mx-auto sm:px-6 lg:max-w-none lg:mx-0 lg:px-0 lg:flex-none lg:w-5/12">
        <div>
          <img src="/assets/images/icons/icon-desktop-app.svg" alt="Desktop App" />
        </div>
        <div>
          ...
          <p class="py-8">
            Don’t want to clutter the desk? There’s no need for a physical phone then. Make your calls straight from
            your
      ...
      <div class="w-3/4 mx-auto lg:mt-0 lg:flex-1">
        <img class="mx-auto lg:left-0 lg:w-auto lg:-mr-12" src="/assets/images/desktop-app.png" alt="OMNIA preview" />
      </div>
    </div>
  </div>
  ...
  <div class="bg-white">
    <div class="px-4 lg:mx-auto lg:max-w-7xl lg:px-8 pt-12 pb-24">
      <img class="mx-auto" src="/assets/images/icons/icon-trunks.svg" alt="PBX Features" />
      <h1 class="text-3xl font-bold text-voxo-gray-header tracking-tight md:text-5xl text-center pt-4 pb-6">
        SIP Trunks
      </h1>
      <p class="max-w-4xl mx-auto text-center">
        Some of our clients have recently invested in an On-Prem PBX, but still want the support, infrastructure, and
        personal
        relationship VOXO brings to the telecom experience. No worries! We provide low cost SIP trunks that provide dial
        tone
        to your On-Prem PBX, installed without hassle. You can still manage your numbers and basic call flow from our
        portal too!
      </p>
      <img class="mx-auto pt-24" src="/assets/images/sip_trunk_image.png" alt="SIP Trunks" />
    </div>
  </div>
  ...
  <div id="custom-development" class="bg-gradient-to-l from-voxo-gray-grad-dark to-transparent transform skew-y-3">
    <div class="transform -skew-y-3 py-24">
      <div
        class="lg:mx-auto lg:max-w-7xl lg:px-8 flex lg:space-x-8 sm:justify-between items-center flex-wrap transform">
        <div class="px-4 max-w-xl mx-auto sm:px-6 lg:max-w-none lg:mx-0 lg:px-0 lg:flex-none lg:w-5/12">
          <div>
            <img src="/assets/images/icons/icon-custom-dev.svg" alt="Desktop App" />
          </div>
          <div>
            <h1 class="text-3xl text-voxo-gray-header tracking-tight md:text-5xl">
              Custom Development
            ...
            <p class="py-8">
              Need more customization? Does that plug-and-play integration not give you exactly what you need to make
              your
              system work for your business? Our entire platform was built in house and with enterprise customers in
              mind.
              This means that you’re talking to the source when needing a custom solution developed. There’s no in
              between.
              VOXO is not a reseller. Part of our mission to “Fix Telecom” means that we want to innovate alongside you.
              Our
        ...
        <div class="w-3/4 mx-auto lg:mt-0 lg:flex-1 flex justify-center items-center">
          <img class="mx-auto lg:left-0 lg:w-auto lg:-mr-12" src="/assets/images/custom_dev.png"
  ...
  <div id="our-infrastructure" class="mt-12">
    <div class="px-4 lg:mx-auto lg:max-w-7xl lg:px-8 pt-12 pb-24">
      <img class="mx-auto" src="/assets/images/icons/icon-infrastructure.svg" alt="PBX Features" />
      <h1 class="text-3xl text-voxo-gray-header tracking-tight md:text-5xl text-center pt-4 pb-6">
        Our Infrastructure
      </h1>
      <p class="max-w-4xl mx-auto text-center">
      ...
      <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-9">
        <div class="rounded-md shadow">
          <a href="https://github.com/voxoco/k8s"
            class="w-full flex items-center justify-center px-8 py-3 border-transparent text-base font-medium rounded-lg text-white bg-voxo-gray-dark md:py-3 md:text-lg hover:bg-voxo-gray shadow-md">
            <span class="pr-2"><svg fill="currentColor" viewBox="0 0 24 24" class="h-6 w-6" aria-hidden="true">
              ...
              </svg></span><span> GitHub Demo</span>
          </a>
        </div>
      </div>
      <iframe height="1000" class="mx-auto pt-12 w-full"
        src="https://isoflow.io/app/project/cknuw4pyddjjq0738cnikqcbv"></iframe>
    </div>
  </div>
</template>
