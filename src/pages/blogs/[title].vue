  ...
  <div class="relative overflow-hidden">
    ...
    <div class="bg-gradient-to-b from-voxo-gray-light to-transparent relative z-10">
      <div class="max-w-prose mx-auto px-4 sm:px-6">
        <h1 class="pt-16">
          <span
            class="block text-base text-center text-voxo-red font-einasemibold tracking-wide uppercase">Introducing</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-einabold tracking-tight sm:text-4xl">{{
              currentBlog.title
          }}</span>
        </h1>
