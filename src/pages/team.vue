<template>
  <div class="bg-white">
    <div class="relative">
      <img class="w-full object-cover h-80" src="/assets/images/team-banner.jpg" alt="Our Team" />
    ...
    <div class="max-w-xl lg:max-w-7xl lg:px-8 mx-auto px-4 sm:px-6 py-16">
      ...
      <p class="max-w-4xl mx-auto text-center">
        Changing the world through inspiration, challenging the status quo, forging new paths and solving problems. VOXO
        is the platform that fuels a deeper purpose and allows its team members to do the things that inspire them.
      </p>
      <p class="max-w-4xl mx-auto text-center py-4">
        When a new member joins the VOXO team it isn't because of their resume or talent but rather their character and
        purpose. It is more about their ability to believe in and embody the VOXO WHY.
      </p>
    </div>
  </div>
