<template>
  ...
  <div class="mt-24">
    <div class="pt-1 bg-voxo-gray-light relative">
      ...
      <div class="relative z-10">
        <div
          class="lg:mx-auto lg:max-w-7xl lg:px-8 flex items-center sm:justify-between relative z-10 flex-wrap pb-16 lg:pt-0">
          <div class="w-3/4 lg:mt-0 lg:flex-1 lg:block lg:order-1 order-2 mx-auto">
            <img class="mx-auto lg:w-auto" src="/assets/images/join-team.svg" alt="Join Our Team" />
          </div>
          <div
            ...
            <div>
              ...
              <p class="pt-6 lg:pb-8 text-base">
                You will frequently hear of our commitment to building relationships. It's integral to who we are. And a
                key part of how we build relationships is by adding real value to the lives of everyone we touch,
                whether clients or team members we are committed to adding value.
              </p>
              <div class="rounded-md">
                <div
                  class="hover:bg-voxo-red-dark shadow-md cursor-pointer my-10 font-einasemibold w-3/4 flex items-center justify-center px-8 py-3 border-transparent text-base font-medium rounded-lg text-white bg-voxo-red md:py-3 md:text-lg lg:mx-0"
                  @click="open = true">
        ...
        <TransitionChild as="template" enter="ease-out duration-300"
          ...
          <div
            ...
            <div class="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
              <button type="button" class="bg-white rounded-md text-voxo-gray-dark focus:outline-none"
                @click="open = false">
              ...
              <div class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8 ">
                <label for="first-name" class="block text-sm font-medium text-gray-700">First Name
                  <div class="mt-1 border-gray-300 ">
                    <input id="first-name" v-model="employForm.firstName" type="text" name="first-name"
                ...
                <div>
                  <label for="last-name" class="block text-sm font-medium text-gray-700">Last Name
                    <div class="mt-1 border-gray-300 ">
                      <input id="last-name" v-model="employForm.lastName" type="text" name="last-name"
                ...
                <div>
                  <label for="email" class="block text-sm font-medium text-gray-700">Email
                    <div class="mt-1 border-gray-300 ">
                      <input id="email" v-model="employForm.email" name="email" type="email" autocomplete="email"
                        class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                  </label>
                </div>
                <div>
                  <label for="phone" class="block text-sm font-medium text-gray-700">Phone
                    <div class="mt-1 border-gray-300 ">
                      <input id="phone" v-model="employForm.phone" type="text" name="phone" autocomplete="tel"
                        class="mt-1 focus:ring-red-500 focus:border-red-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                  </label>
                </div>
                <div class="sm:col-span-2">
                  <select id="position" v-model="employForm.position" name="position"
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <textarea id="message" v-model="employForm.message" name="message" rows="4"
  ...
  <div aria-live="assertive"
    class="fixed top-0 inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start z-40">
          ...
          <div class="p-4">
            <div class="flex items-start">
              ...
              <div class="ml-4 flex-shrink-0 flex">
                <button
                  class="bg-white rounded-md inline-flex text-voxo-gray-dark hover:text-gray-500 focus:outline-none"
                  @click="show = false">
                  <span class="sr-only">Close</span>
  ...
  <!-- Global notification live region, render this permanently at the end of the document -->
  <div aria-live="assertive"
    class="fixed top-0 inset-0 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start z-50">
    <div class="w-full flex flex-col items-center space-y-4 sm:items-end">
      <!-- Notification panel, dynamically insert this into the live region when it needs to be displayed -->
      <transition enter-active-class="transform ease-out duration-300 transition"
        enter-from-class="translate-y-2 opacity-0 sm:translate-y-0 sm:translate-x-2"
