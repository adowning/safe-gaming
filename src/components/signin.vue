      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="flex items-center space-x-2 ml-auto">
          <a
            ...
            href="#"
          >
            <i class="text-gray-400 w-5 fa fa-user" />
          ...
          <a
            ...
            href="#"
          >
            <i class="text-gray-400 w-5 fa fa-heart" />
          ...
          <a
            ...
            href="#"
          >
            <i class="text-gray-400 w-5 fa fa-shopping-cart" />
    ...
    <div class="container max-w-screen-xl mx-auto px-4">
      ...
      <div style="max-width:360px" class="mt-10 mb-20 p-4 md:p-7 mx-auto rounded bg-white shadow-lg">
        <form action="">
          ...
          <a
            href="#"
            class="mb-2 px-4 py-2 w-full flex items-center justify-center text-center text-gray-700 bg-white shadow-sm border border-gray-200 rounded-md hover:bg-gray-100 hover:text-blue-600"
          >
