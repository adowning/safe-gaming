...
<template>
  <div class="register-form" :class="{ loading, wiggle: formWiggle }">
    ...
    <form id="register" ref="registerForm" method="post" @submit.prevent="register">
      ...
      <FormInput id="repeat-password" v-model="repeatPassword" label="Repeat password" type="password" />
      <div class="captcha-container">
        <div class="captcha-box">
          <img class="captcha-image" :src="captchaImage" alt="Captcha image">
        </div>
      </div>
      <FormInput id="image-captcha" v-model="captchaSolution" label="Captcha" type="text" />
